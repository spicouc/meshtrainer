...
echo "============================================" | tee "$GATE_LOG"
echo "  GENERIC DISTRIBUTED FINAL GATE (R2.3)" | tee -a "$GATE_LOG"
...
echo "" | tee -a "$GATE_LOG"
echo "============================================" | tee -a "$GATE_LOG"
echo "  GENERIC DISTRIBUTED FINAL GATE (R2.3) — Overall: $([ $OVERALL -eq 0 ] && echo PASS || echo FAIL)" | tee -a "$GATE_LOG"
echo "============================================" | tee -a "$GATE_LOG"
exit $OVERALL
